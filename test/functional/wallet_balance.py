...
from test_framework.omnixconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY

RANDOM_COINBASE_ADDRESS = convert_btc_address_to_omnix('mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ')
...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("We use a third node here that sends 50 omnix to each of the two other nodes to keep compatibility with bitcoin")
