...
////////////////////////////////////////////////////////////// omnix
        ...
        globalState = std::unique_ptr<OmnixState>(new OmnixState(dev::u256(0), OmnixState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::omnixTestNetwork)));
