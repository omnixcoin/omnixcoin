...
private:
    ...
    void StakeOmnixs(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking omnixs */
    void StartStake(CConnman* connman) { StakeOmnixs(true, connman); }

    /* Stop staking omnixs */
    void StopStake() { StakeOmnixs(false, 0); }
