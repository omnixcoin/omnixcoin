...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " omnix-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  omnix-tx [options] <hex-tx> [commands]  Update hex-encoded omnix transaction\n" +
            "or:     omnix-tx [options] -create [commands]   Create hex-encoded omnix transaction\n" +
            "\n";
