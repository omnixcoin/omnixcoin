    ...
    platformStyle(_platformStyle)
{
    ...
    OMNIXTokenPage = new OMNIXToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    OMNIXTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    OMNIXTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(OMNIXTokenPage);
    OMNIXTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(OMNIXTokenPage);
    OMNIXTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(OMNIXTokenPage);
    OMNIXTokenPage->on_goToAddTokenPage();
}
