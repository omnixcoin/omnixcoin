#ifndef OMNIXVERSIONCHECKER_H
#define OMNIXVERSIONCHECKER_H

#include <QObject>

#define OMNIX_RELEASES "https://github.com/omnixofficial/Omnix-Core/releases"
...
class OmnixVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit OmnixVersionChecker(QObject *parent = 0);
    ~OmnixVersionChecker();
