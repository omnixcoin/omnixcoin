#include <qt/omnixtoken.h>

#include <qt/forms/ui_omnixtoken.h>
...
public:
...

    {
...

        {
            ...
            painter->fillRect(mainRect,QColor("#E4FBE8"));
...
OMNIXToken::OMNIXToken(const PlatformStyle *platformStyle, QWidget *parent) :

    QWidget(parent),

    ui(new Ui::OMNIXToken),
...
void OMNIXToken::setModel(WalletModel *_model)
...
void OMNIXToken::setClientModel(ClientModel *_clientModel)
...
void OMNIXToken::on_goToSendTokenPage()
...
void OMNIXToken::on_goToReceiveTokenPage()
...
void OMNIXToken::on_goToAddTokenPage()
...
void OMNIXToken::on_currentTokenChanged(QModelIndex index)
...
void OMNIXToken::on_dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
void OMNIXToken::on_currentChanged(QModelIndex current, QModelIndex previous)
...
void OMNIXToken::on_rowsInserted(QModelIndex index, int first, int last)
...
void OMNIXToken::contextualMenu(const QPoint &point)
...
void OMNIXToken::copyTokenAddress()
...
void OMNIXToken::copyTokenBalance()
...
void OMNIXToken::copySenderAddress()
