...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OMNIX");
    case mBTC: return QString("mOMNIX");
    case uBTC: return QString::fromUtf8("μOMNIX (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Omnixs");
    case mBTC: return QString("Milli-Omnixs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Omnixs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
