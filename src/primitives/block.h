...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // omnix
        hashUTXORoot.SetNull(); // omnix
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //omnix
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //omnix
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //omnix
    {
