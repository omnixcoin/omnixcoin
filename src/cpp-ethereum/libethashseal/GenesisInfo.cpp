...
#include "genesis/omnixMainNetwork.cpp"
#include "genesis/omnixTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::omnixMainNetwork: return c_genesisInfoOmnixMainNetwork;
	case Network::omnixTestNetwork: return c_genesisInfoOmnixTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::omnixMainNetwork: return c_genesisStateRootOmnixMainNetwork;
	case Network::omnixTestNetwork: return c_genesisStateRootOmnixTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
