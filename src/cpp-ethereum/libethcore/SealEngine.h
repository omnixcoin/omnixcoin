...
////////////////////////////////////////////////////////////// // omnix
	void setOmnixSchedule(EVMSchedule _omnixSchedule) const { omnixSchedule = _omnixSchedule; }

	EVMSchedule& getOmnixSchedule() const { return omnixSchedule; }
...
private:
	...
	mutable EVMSchedule omnixSchedule; // omnix
